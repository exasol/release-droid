...
class ProjectValidatorTest {
    ...
    void testValidateChangeLog() {
        final ProjectValidatorDummy validator = new ProjectValidatorDummy(null);
    ...
    static class ProjectValidatorDummy extends AbstractProjectValidator {
        public ProjectValidatorDummy(final GitHubRepository repository) {
            super(repository);
        }
