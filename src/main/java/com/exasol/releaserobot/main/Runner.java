...
import com.exasol.releaserobot.ReleaseInteractor;
import com.exasol.releaserobot.ReleaseRobot;
import com.exasol.releaserobot.ReleaseUseCase;
import com.exasol.releaserobot.RepositoryHandler;
import com.exasol.releaserobot.UserInput;
import com.exasol.releaserobot.ValidateInteractor;
import com.exasol.releaserobot.ValidateUseCase;
		...
		for (final PlatformName name : userInput.getPlatformNames()) {
			if (name == GITHUB) {
				...
				throw new UnsupportedOperationException(
						"E-RR-REL-1: Release for platform " + name + " is not supported. Please choose one of: "
